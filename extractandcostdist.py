...
for row in cursor:
	...
	where = '"FID" =' + FID
	out_fl='fl_{0}'.format(FID) #not big on this, whats the .format( ) doing?: could be right, I haven't seen something like that in Python, check that it produces what you expect
	print out_fl
	...
	#this else isn't meaningful here: all rows are going to be in cursor anyway! Instead you can just dedent the code
print 'rangedone'
